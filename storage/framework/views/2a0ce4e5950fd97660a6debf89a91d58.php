    ...
    <div class="main-content">
        ...
        <main>
            <div class="container">
                ...
                <!-- Filters -->
                <form method="GET" action="<?php echo e(route('modules.my')); ?>" style="display: flex; gap: 0.75rem; margin-bottom: 1.5rem; flex-wrap: wrap; align-items: flex-end;">
                    ...
                    <?php if(request('search') || request('status') || request('teacher')): ?>
                        <a href="<?php echo e(route('modules.my')); ?>" class="btn btn-secondary btn-sm" style="align-self: flex-end;">Clear</a>
                    <?php endif; ?>
                </form>
                            ...
                            <div class="module-body">
                                ...
                                <?php if(auth()->user()->role === 'student'): ?>
                                    <div class="progress-bar-container">
                                        <div class="progress-text">
                                            <span>Progress</span>
                                            <span><?php echo e($module->progress); ?>%</span>
                                        </div>
                                        <div class="progress-bar-wrapper">
                                            <div class="progress-bar-fill" style="width: <?php echo e($module->progress); ?>%;"></div>
                                        </div>
                                        <?php if($module->pdf_completed): ?>
                                ...
                                <div class="module-footer">
                                    ...
                                    <div class="module-actions">
                                        <?php if(auth()->user()->role === 'student'): ?>
                                            <a href="<?php echo e(route('modules.show', $module->id)); ?>" class="btn btn-primary btn-sm">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="empty-state" style="grid-column: 1 / -1;">
                            ...
                            <?php if(auth()->user()->role === 'student'): ?>
                                ...
                                <a href="<?php echo e(route('modules.all')); ?>" class="btn btn-primary" style="margin-top: 1rem;">
                                    Browse Modules
                                </a>
                            <?php else: ?>
...
<?php /**PATH C:\Users\Mikaella\Studyhive-Final\resources\views/modules/my.blade.php ENDPATH**/ ?>