    ...
    <div class="email-wrapper">
        ...
        <div class="email-body">
            ...
            <p style="text-align: center;">
                <a href="<?php echo e(url('/login')); ?>" class="btn-login">Log In Now</a>
            </p>
        </div>
        <div class="email-footer">
            <p>&copy; <?php echo e(date('Y')); ?> Studyhive | CSS NC II Training Program</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Mikaella\Studyhive-Final\resources\views/emails/account-approved.blade.php ENDPATH**/ ?>