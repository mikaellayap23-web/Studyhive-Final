            ...
            <div class="container">
                 <div class="page-header">
                     ...
                     <div style="display: flex; gap: 0.5rem;">
                         <form action="<?php echo e(route('modules.duplicate', $module->id)); ?>" method="POST" onsubmit="return confirm('Duplicate this module? A new draft copy will be created.')">
                             <?php echo csrf_field(); ?>
                         ...
                         <a href="<?php echo e(route('modules.index')); ?>" class="btn btn-secondary">Back to Modules</a>
                     </div>
                 </div>

                <div class="card" style="background: white; border: 1px solid #e2e8e4; border-radius: 8px; padding: 1.5rem;">
                    <form action="<?php echo e(route('modules.update', $module->id)); ?>" method="POST" enctype="multipart/form-data" id="module-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="title" name="title" value="<?php echo e(old('title', $module->title)); ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="order">Order *</label>
                                <input type="number" id="order" name="order" value="<?php echo e(old('order', $module->order)); ?>" min="0" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea id="description" name="description" rows="3"><?php echo e(old('description', $module->description)); ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($module->image_path): ?>
                                <div style="margin-bottom: 0.75rem;">
                                    <img src="<?php echo e(asset('storage/' . $module->image_path)); ?>" alt="Current Image" style="max-width: 100%; max-height: 200px; border-radius: 6px; object-fit: cover;">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="error-text" style="color: #991b1b; font-size: 0.8rem; margin-top: 0.5rem;"><?php echo e($message); ?></p>
                            <?php unset($message);
                         ...
                         <?php if(auth()->user()->role === 'admin'): ?>
                             <div class="form-group">
                                 ...
                                 <select id="assigned_teacher_id" name="assigned_teacher_id">
                                     ...
                                     <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('assigned_teacher_id', $module->assigned_teacher_id) == $teacher->id ? 'selected' : ''); ?>>
                                             <?php echo e($teacher->first_name); ?> <?php echo e($teacher->last_name); ?> (<?php echo e($teacher->username); ?>)
                                         </option>
                             ...
                             <div class="form-group">
                                 ...
                                 <select id="prerequisite_module_id" name="prerequisite_module_id">
                                     ...
                                     <?php $__currentLoopData = \App\Models\Module::where('status', 'published')->whereNull('deleted_at')->where('id', '!=', $module->id)->orderBy('title')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preModule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <option value="<?php echo e($preModule->id); ?>" <?php echo e(old('prerequisite_module_id', $module->prerequisite_module_id) == $preModule->id ? 'selected' : ''); ?>>
                                             <?php echo e($preModule->title); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($module->file_path): ?>
                                <div style="padding: 0.75rem; background: #f8faf9; border-radius: 6px; margin-bottom: 0.75rem;">
                                    ...
                                    <span><?php echo e(basename($module->file_path)); ?></span>
                                </div>
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="assessment-section">
                        ...
                        <?php if($module->assessment): ?>
                            <div class="existing-assessment-info">
                                ...
                                <?php echo e($module->assessment->title); ?> 
                                <span style="color: #706f6c; font-size: 0.85rem;">(<?php echo e(count($module->assessment->questions)); ?> questions, <?php echo e($module->assessment->duration_minutes); ?> min)</span>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="assessment-fields" id="assessment-fields">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="assessment_title" name="assessment[title]" value="<?php echo e(old('assessment.title', $module->assessment->title ?? '')); ?>" placeholder="e.g., Module 1 Quiz">
                                </div>

                                <div class="form-group">
                                    <label for="assessment_duration">Duration (minutes) *</label>
                                    <input type="number" id="assessment_duration" name="assessment[duration_minutes]" value="<?php echo e(old('assessment.duration_minutes', $module->assessment->duration_minutes ?? 60)); ?>" min="1">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="assessment_passing" name="assessment[passing_score]" value="<?php echo e(old('assessment.passing_score', $module->assessment->passing_score ?? 75)); ?>" min="0" max="100">
                                </div>

                                <div class="form-group">
                                    <label for="assessment_attempts">Max Attempts (0 = unlimited) *</label>
                                    <input type="number" id="assessment_attempts" name="assessment[max_attempts]" value="<?php echo e(old('assessment.max_attempts', $module->assessment->max_attempts ?? 1)); ?>" min="0">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="checkbox-wrapper">
                                    <input type="checkbox" name="assessment[is_published]" value="1" <?php echo e(old('assessment.is_published', $module->assessment->is_published ?? false) ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group">
                                <label class="checkbox-wrapper">
                                    <input type="checkbox" name="assessment[show_correct_answer]" value="1" <?php echo e(old('assessment.show_correct_answer', $module->assessment->show_correct_answer ?? false) ? 'checked' : ''); ?>>
                        ...
                        <div class="form-group" style="display: flex; gap: 0.75rem; margin-top: 1.5rem;">
                            ...
                            <a href="<?php echo e(route('modules.index')); ?>" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        let questionCount = 0;
        const existingQuestions = <?php echo json_encode($module->assessment->questions ?? [], 15, 512) ?>;
            ...
            const questionHtml = `
                <div class="question-item" id="question-${questionCount}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="question-text" value="<?php echo e(old('questions.${questionCount}.text', '')); ?>" placeholder="Enter your question" required>
                    </div>
                    <div class="form-group">
                        <label>Points *</label>
                        <input type="number" class="question-points" value="<?php echo e(old('questions.${questionCount}.points', 1)); ?>" min="1" required>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="options-container">
                            <div class="option-row">
                                ...
                                <input type="text" class="option-text" value="<?php echo e(old('questions.${questionCount}.options.0', '')); ?>" placeholder="Option A" required>
                            </div>
                            <div class="option-row">
                                <input type="radio" name="correct-${questionCount}" value="1" ${parseInt(question.correct_answer) === 1 ? 'checked' : ''}>
                                <input type="text" class="option-text" value="<?php echo e(old('questions.${questionCount}.options.1', '')); ?>" placeholder="Option B" required>
                            </div>
                            <div class="option-row">
                                <input type="radio" name="correct-${questionCount}" value="2" ${parseInt(question.correct_answer) === 2 ? 'checked' : ''}>
                                <input type="text" class="option-text" value="<?php echo e(old('questions.${questionCount}.options.2', '')); ?>" placeholder="Option C" required>
                            </div>
                            <div class="option-row">
                                <input type="radio" name="correct-${questionCount}" value="3" ${parseInt(question.correct_answer) === 3 ? 'checked' : ''}>
                                <input type="text" class="option-text" value="<?php echo e(old('questions.${questionCount}.options.3', '')); ?>" placeholder="Option D" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\Mikaella\Studyhive-Final\resources\views/modules/edit.blade.php ENDPATH**/ ?>