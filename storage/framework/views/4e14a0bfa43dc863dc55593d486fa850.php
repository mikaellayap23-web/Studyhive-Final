        ...
        <main>
            <div class="container">
                ...
                <div class="card" style="background: white; border: 1px solid #e2e8e4; border-radius: 8px; padding: 1.5rem;">
                    <form action="<?php echo e(route('modules.store')); ?>" method="POST" enctype="multipart/form-data" id="module-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="order" name="order" value="<?php echo e(old('order', 0)); ?>" min="0" required>
                            </div>
                        </div>
                         ...
                         <?php if(auth()->user()->role === 'admin'): ?>
                             <div class="form-group">
                                 ...
                                 <select id="assigned_teacher_id" name="assigned_teacher_id">
                                     ...
                                     <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('assigned_teacher_id') == $teacher->id ? 'selected' : ''); ?>>
                             ...
                             <div class="form-group">
                                 ...
                                 <select id="prerequisite_module_id" name="prerequisite_module_id">
                                     ...
                                     <?php $__currentLoopData = \App\Models\Module::where('status', 'published')->whereNull('deleted_at')->orderBy('title')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preModule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <option value="<?php echo e($preModule->id); ?>" <?php echo e(old('prerequisite_module_id') == $preModule->id ? 'selected' : ''); ?>>
...
<?php /**PATH C:\Users\Mikaella\Studyhive-Final\resources\views/modules/create.blade.php ENDPATH**/ ?>